...
<%-- <%@ include file="AllCrud.jsp" %>
 --%>
	<h1>&emsp; &emsp;&emsp; &emsp;&emsp; &emsp;&emsp; &emsp;Update Your Details....</h1>
	<html:form action="update" method="post">
		<table>
			<tr><td><label>&emsp; &emsp;&emsp; &emsp;&emsp; &emsp;&emsp; &emsp;Old Id :</label></td><td><html:text style=" border-radius: 50vw;" property="oldid"></html:text></td></tr>
			...
			<td><html:submit style="
							  ...
							  text-decoration: none;
							  display: inline-block;
							  font-size: 15px; border-radius: 50vw;" value="Update"></html:submit></td></tr>
		</table>
	</html:form>
