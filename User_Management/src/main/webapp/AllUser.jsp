...
<body background="image9.jpg" style="background-repeat: no-repeat; background-size:100%; background-size: cover;">
	<div>	
	<% if(session.getAttribute("username") == null) request.getRequestDispatcher("Login.jsp").forward(request, response); %>
		...
		<a href="http://localhost:8080/PersonProject/Login.jsp"><button>Log Out</button></a>
		<br><br>
